### Achtung: Ich bin aktuell dabei, das ganze hier aufzuräumen um den aktuellen Stand in ein Release zu gießen, um danach vernünftig weiterentwickeln zu können! Es kann sein das es zu ungültigen Dateien kommt, also nehmt ersteinmal Abstand die Daten von hier zu nehmen bis ich ein offizelles Release hier gemacht habe! Momentan bin ich dabei die Hardware nach KiCad 5.xx zu konvertieren. Ich bin also dran ;)
### Stand: 14.04.2020
# 1541-rebuild
